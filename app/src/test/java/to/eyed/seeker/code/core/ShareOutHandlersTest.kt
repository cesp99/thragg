...
class ShareOutHandlersTest {
    ...
    private val own = "to.eyed.seeker.code"
    private val us = ViewHandler(own, "to.eyed.seeker.code.MainActivity")
    ...
    fun everyActivityOfOurPackageCountsAsOurs() {
        val alias = ViewHandler(own, "to.eyed.seeker.code.SomeAlias")
