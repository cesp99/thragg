 ...
 * `Java_to_eyed_thragg_core_CoreBridge_<name>` symbol in the Rust
...
object CoreBridge {
     ...
     * [to.eyed.thragg.core.Languages], which caches it.
     */
     ...
     * [to.eyed.thragg.ui.editor.SyntaxPalette]). Empty when the
     ...
     * userland reports [to.eyed.thragg.terminal.UserlandState.Ready],
     ...
     * [to.eyed.thragg.ui.editor.ConflictRegion], which parses it. Zed's
     ...
     * ([to.eyed.thragg.ui.editor.EditorState.noteExternalEdit]).
     ...
     * of the process — [to.eyed.thragg.ui.editor.EditorLanguage] caches
