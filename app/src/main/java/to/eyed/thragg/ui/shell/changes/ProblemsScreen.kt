...
import to.eyed.thragg.ui.editor.rememberProjectDiagnostics
 ...
 * the pane's own flattening ([to.eyed.thragg.ui.diagnostics.diagnosticsRows])
 ...
 * [to.eyed.thragg.solana.build.BuildDiagnostics.agentPrompt] uses for a
