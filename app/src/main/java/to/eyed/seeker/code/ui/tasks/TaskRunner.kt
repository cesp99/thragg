...
import to.eyed.seeker.code.core.TaskHistory
import to.eyed.seeker.code.core.TaskSpec
import to.eyed.seeker.code.core.oneshotTemplateJson
import to.eyed.seeker.code.core.taskEnvironmentRows
import to.eyed.seeker.code.core.taskShellLine
 ...
 *
 * The history is process-wide like [to.eyed.seeker.code.terminal.TerminalSessions],
