...
import to.eyed.seeker.code.solana.chain.BackgroundWork
...
import to.eyed.seeker.code.ui.shell.projects.SheetButtons
import to.eyed.seeker.code.ui.shell.settings.FactRow
        ...
        Column(
            ...
            if (!unrestricted) {
                NoticeCard(
                    ...
                    body = "A deploy takes minutes of network. Letting Seeker IDE run unrestricted keeps it going in your pocket.",
                    actions = {
                        SeekerChip(
