 ...
 * testable. [to.eyed.seeker.code.ui.workspace.captureSession] builds one
 * from the live workspace and
 * [to.eyed.seeker.code.ui.workspace.applySession] puts one back.
 *
...
data class SessionItem(
    ...
    /** [to.eyed.seeker.code.ui.editor.EditorState.scrollY] in pixels. */
    val scroll: Float = 0f,
...
/** One entry of a pane's jump list — [to.eyed.seeker.code.ui.workspace.NavEntry]. */
