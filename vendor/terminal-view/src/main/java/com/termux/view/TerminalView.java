...
public final class TerminalView extends View {
    ...
    // private and owns the handles and the copy toolbar, neither of which a
    // search match wants.
    private final int[] mHighlight = new int[]{-1, -1, -1, -1};
     ...
     * colour, without starting a selection. Rows are in the emulator's
     * external coordinates: negative rows are in the transcript.
     */
    ...
    public void clearHighlight() {
        if (mHighlight[0] == -1) return;
        mHighlight[0] = mHighlight[1] = mHighlight[2] = mHighlight[3] = -1;
        invalidate();
    }
